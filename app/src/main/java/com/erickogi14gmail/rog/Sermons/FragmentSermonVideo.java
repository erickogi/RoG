...
import com.erickogi14gmail.rog.utills.VideoPlayer;
...
public class FragmentSermonVideo extends Fragment {
    private View view;
    ...
    private void setView(){
        ...
        sermonAdapter=new SermonAdapter(getContext(),populateList(),"Video");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Video Sermons");
        setView();
